    ...
    public partial class initCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        ProvidedMediaId = c.Int(nullable: false),
                        ConvertedMediaId = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Media", t => t.ConvertedMediaId)
                .ForeignKey("dbo.Media", t => t.ProvidedMediaId)
                .ForeignKey("dbo.AspNetUsers", t => t.UserId)
                .Index(t => t.ProvidedMediaId)
                .Index(t => t.ConvertedMediaId)
                .Index(t => t.UserId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Conversions", "UserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Conversions", new[] { "UserId" });
